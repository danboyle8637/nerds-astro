...
socialImage: https://ik.imagekit.io/csu76xuqqlwj/nerds-who-sell/seo/nerds-blog-writing-social-1200x630_nrar-PB6LH.jpg?ik-sdk-version=javascript-1.4.3
headline: Blog Posts
...
<UnorderedList>
  <PunctuationBullet
    type="check"
    bullet="Where to include images"
  ></PunctuationBullet>
  <PunctuationBullet
    type="check"
    bullet="What images or graphics to include"
  ></PunctuationBullet>
  <PunctuationBullet
    type="check"
    bullet="Where to insert call to actions"
  ></PunctuationBullet>
</UnorderedList>
